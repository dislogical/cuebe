...
<a name="Serve"></a>
## func [Serve](<https://github.com/bonk-build/bonk/blob/0cbdd6d/api/go/plugin.go#L73>)
...
## type [BonkBackend](<https://github.com/bonk-build/bonk/blob/0cbdd6d/api/go/plugin.go#L34-L39>)
...
<a name="NewBackend"></a>
### func [NewBackend](<https://github.com/bonk-build/bonk/blob/0cbdd6d/api/go/plugin.go#L42-L46>)
...
<a name="TaskParams"></a>
## type [TaskParams](<https://github.com/bonk-build/bonk/blob/0cbdd6d/api/go/plugin.go#L27-L31>)
